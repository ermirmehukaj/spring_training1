...
public interface EmployeeRepository extends JpaRepository<Employee,Integer> {
    ...
    //Display all employees that has ben hired beetwen "" and ""
    List<Employee> findByHireDateBetween(LocalDate startDate,LocalDate endDate);

    //Display all empoyees where salaries grater and equal to "" in order-salary

    List<Employee> findBySalaryGreaterThanEqualOrdeOrderBySalary(Integer salary);
